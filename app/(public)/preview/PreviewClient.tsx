  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <div id="pricing" className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="text-center mb-6">
              ...
              {/* Credit pack discount note */}
              <div className="mt-3 inline-flex items-center gap-1.5 bg-gray-100 border border-gray-300 text-gray-600 text-xs font-medium px-3 py-1.5 rounded-full">
          ...
          >
            ...
            {/* Credit Pack Savings Highlight */}
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-300 rounded-xl p-4 mb-6">
        ...
        {/* Plan comparison callout — credit pack discount */}
        <motion.div
        ...
        >
          <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-full px-5 py-2.5 text-sm text-emerald-800">
            <svg className="w-4 h-4 text-emerald-600 shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M5 2a2 2 0 00-2 2v14l3.5-2 3.5 2 3.5-2 3.5 2V4a2 2 0 00-2-2H5zm2.5 3a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm6.207.293a1 1 0 00-1.414 0l-6 6a1 1 0 101.414 1.414l6-6a1 1 0 000-1.414zM12.5 10a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" clipRule="evenodd" />
            </svg>
            <span>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 border-b border-gray-200">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Agents are closing more deals with HyveWyre
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From insurance to real estate to solar — see how professionals are transforming their lead outreach.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              quote: "I went from manually texting 20 leads a day to HyveWyre handling 200 conversations at once. Booked 14 appointments in my first week alone.",
              name: "Marcus T.",
            ...
            {
              quote: "The AI knows exactly what to say. It qualifies leads, gets their budget, and books the showing — I just show up. My pipeline has never been fuller.",
              name: "Priya S.",
            ...
            {
              quote: "We sent a bulk campaign to 800 homeowners and got 60+ responses in 24 hours. The flow handled every single conversation automatically.",
              name: "Derek W.",
            ...
            {
              quote: "Opt-outs and compliance used to stress me out. HyveWyre handles all of it automatically — STOP replies, DNC blocking, the whole thing.",
              name: "Rachel M.",
              role: "Health Insurance Broker",
              location: "Atlanta, GA",
              initials: "RM",
              gradient: "from-emerald-500 to-teal-500",
            },
            {
              quote: "The ROI in month one was unreal. Credits are cheap, and the quality of booked calls is way higher than anything I got from cold calling.",
              name: "James K.",
            ...
            {
              quote: "After every storm I upload my lead list and HyveWyre does the rest. My crew just focuses on the jobs — not chasing down callbacks.",
              name: "Angela F.",
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 bg-white border border-gray-200 rounded-xl hover:border-teal-400 hover:shadow-md transition-all shadow-sm flex flex-col"
            >
              {/* Stars */}
              ...
              {/* Author */}
              <div className="flex items-center gap-3">
                <div className={`w-11 h-11 bg-gradient-to-br ${t.gradient} rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0`}>
                  {t.initials}
                </div>
                <div>
        ...
        <motion.div
          ...
          transition={{ delay: 0.4, duration: 0.6 }}
          viewport={{ once: true }}
          className="flex flex-wrap items-center justify-center gap-8 mt-14 pt-10 border-t border-gray-200"
        >
          {[
            { value: "10,000+", label: "Leads contacted daily" },
            { value: "68%", label: "Average response rate" },
            { value: "3.2x", label: "More appointments booked" },

...
export default function PreviewClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f1419] via-[#1a1f2e] to-[#0f1419]">
      ...
      <div className="relative overflow-hidden">
        ...
        <nav className="relative z-10 flex items-center justify-between p-4 sm:p-6 max-w-7xl mx-auto gap-4">
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-2xl flex items-center justify-center">
          ...
          <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/auth/register"
                className="px-4 py-2 sm:px-6 text-sm sm:text-base bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-emerald-500 hover:to-teal-500 text-white font-medium rounded-lg transition-all whitespace-nowrap inline-block"
              >
                Get Started
              </Link>
            </motion.div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
          <motion.div
            ...
            className="inline-block mb-4 px-4 py-2 bg-emerald-500/10 border border-emerald-500/30 rounded-full text-emerald-400 text-sm font-medium"
          >
          ...
          >
            ...
            <span className="bg-gradient-to-r from-emerald-300 to-slate-300 bg-clip-text text-transparent">
          ...
          >
            <div className="flex items-center justify-center gap-4">
              <motion.button
                ...
                className="px-8 py-4 bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold rounded-lg transition-all shadow-lg shadow-emerald-500/20"
              >
                View Pricing
              </motion.button>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <div className="relative z-10 w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/20">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 border-b border-white/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="text-emerald-400 font-semibold mb-2">AI-POWERED CONVERSATIONS</div>
            <h3 className="text-3xl font-bold text-white mb-4">Let AI Handle the Conversation</h3>
            ...
            <div className="space-y-4">
              <div className="flex justify-start">
                <div className="bg-white/10 rounded-lg px-4 py-2 max-w-[80%]">
                  <p className="text-white">Hi, I saw your ad about home insurance. What kind of rates do you offer?</p>
                  <p className="text-white/40 text-xs mt-1">Lead • 2:34 PM</p>
                </div>
              </div>
              <div className="flex justify-end">
                <div className="bg-emerald-600 rounded-lg px-4 py-2 max-w-[80%]">
                  <p className="text-white">Great question! Our rates depend on a few factors. Could you tell me about your home? Is it a single-family house, condo, or townhome?</p>
              ...
              <div className="flex justify-start">
                <div className="bg-white/10 rounded-lg px-4 py-2 max-w-[80%]">
                  <p className="text-white">Single family, 3 bed 2 bath, built in 2015</p>
                  <p className="text-white/40 text-xs mt-1">Lead • 2:36 PM</p>
                </div>
              </div>
              <div className="flex justify-end">
                <div className="bg-emerald-600 rounded-lg px-4 py-2 max-w-[80%]">
                  <p className="text-white">Perfect! A newer home like that typically qualifies for great rates. What's your zip code? I'll pull up specific quotes for your area.</p>
                  <p className="text-white/60 text-xs mt-1 flex items-center gap-1">
                    <span className="w-3 h-3 bg-emerald-400 rounded-full animate-pulse"></span>
                    AI Response • 2:36 PM
                  </p>
              ...
              <div className="mt-4 p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-lg">
                <p className="text-emerald-400 text-sm font-medium">🎯 Lead Score: Hot (87/100)</p>
                <p className="text-white/60 text-xs mt-1">AI detected high intent. Ready for agent handoff.</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="order-2 lg:order-1 bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl p-6"
          >
            {/* Mock Campaign Builder */}
            <div className="space-y-4">
              <div className="flex items-center justify-between pb-4 border-b border-white/10">
                <h4 className="text-white font-semibold">Spring Insurance Campaign</h4>
                <span className="px-3 py-1 bg-emerald-500/20 text-emerald-400 text-sm rounded-full">Draft</span>
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-white/5 rounded-lg">
                  <p className="text-white/60 text-sm">Est. Cost</p>
                  <p className="text-white font-bold text-xl">$42.70</p>
                </div>
              </div>
              <div className="p-4 bg-white/5 rounded-lg">
                <p className="text-white/60 text-sm mb-2">Message Preview</p>
                <p className="text-white">Hi {'{{first_name}}'}, thanks for requesting info about home insurance! With storm season approaching, let's make sure you're covered. Reply YES for a free quote!</p>
              </div>
              <div className="flex gap-2">
                <span className="px-2 py-1 bg-emerald-500/20 text-emerald-400 text-xs rounded">Homeowners</span>
                <span className="px-2 py-1 bg-teal-500/20 text-teal-400 text-xs rounded">Texas</span>
                <span className="px-2 py-1 bg-emerald-400/20 text-emerald-300 text-xs rounded">Active Leads</span>
              </div>
              <button className="w-full py-3 bg-gradient-to-r from-emerald-400 to-teal-400 text-white font-semibold rounded-lg">
                Schedule Campaign →
              </button>
            </div>
          </motion.div>
          ...
          >
            <div className="text-emerald-400 font-semibold mb-2">BULK SMS & EMAIL CAMPAIGNS</div>
            <h3 className="text-3xl font-bold text-white mb-4">Send Thousands of Personalized Messages</h3>
            <p className="text-white/60 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="text-emerald-400 font-semibold mb-2">BUILT-IN CRM</div>
            <h3 className="text-3xl font-bold text-white mb-4">Your Leads, Organized</h3>
            <p className="text-white/60 mb-6">
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="p-4 bg-white/5 rounded-lg border border-white/10 hover:border-emerald-500/30 transition-colors">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex gap-2">
                      {lead.tags.map((tag, j) => (
                        <span key={j} className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 text-xs rounded">{tag}</span>
                      ))}
                    </div>
                    <span className="text-white/40 text-xs">{lead.last}</span>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div id="industries" className="max-w-7xl mx-auto px-6 py-20 border-b border-white/10">
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              className="p-6 bg-white/5 border border-white/10 rounded-xl hover:border-emerald-500/50 transition-all"
            >
              ...
              <div className="pt-4 border-t border-white/10">
                ...
                <div className="text-white/60 text-sm">{item.statLabel}</div>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      {/* FAQ Section */}
      <div id="faq" className="max-w-4xl mx-auto px-6 py-20 border-b border-white/10">
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
      ...
      <div id="features" className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all hover:border-emerald-500/50"
          >
          ...
          <motion.div
            ...
            className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all hover:border-emerald-400/50"
          >
          ...
          <motion.div
            ...
            className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all hover:border-teal-500/50"
          >
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
            ...
            <thead>
              <tr className="border-b border-white/20">
                ...
                <th className="p-4 text-center">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-lg">
                    <div className="w-8 h-8 bg-gradient-to-br from-emerald-300 to-slate-300 rounded-lg flex items-center justify-center">
            ...
            <tbody>
              <tr className="border-b border-white/10 hover:bg-white/5 transition-colors">
                ...
                <td className="p-4 text-center">
                  <span className="inline-flex items-center justify-center w-8 h-8 bg-emerald-500/20 rounded-full">
              ...
              <tr className="border-b border-white/10 hover:bg-white/5 transition-colors">
                ...
                <td className="p-4 text-center">
                  <span className="text-emerald-400 font-bold">$30/mo</span>
                </td>
                <td className="p-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <motion.div
            ...
            className="p-6 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 rounded-xl hover:border-emerald-500/50 transition-all"
          >
          ...
          <motion.div
            ...
            className="p-6 bg-gradient-to-br from-emerald-400/10 to-teal-600/5 border border-emerald-400/20 rounded-xl hover:border-emerald-400/50 transition-all"
          >
            <div className="w-12 h-12 bg-emerald-400 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div id="pricing" className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="p-8 bg-white/5 border-2 border-white/10 rounded-2xl hover:border-emerald-500/50 transition-all"
          >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Link
                ...
                className="block w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg text-center transition-all"
              >
                Get Started
              </Link>
            </motion.div>
          ...
          <motion.div
            ...
            className="relative p-8 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 border-2 border-emerald-400 rounded-2xl"
          >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Link
                ...
                className="block w-full py-3 bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-teal-600 hover:to-teal-600 text-white font-semibold rounded-lg text-center transition-all"
              >
                Get Started
              </Link>
            </motion.div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-emerald-400/20 to-teal-400/20 border border-emerald-500/30 rounded-2xl p-8 md:p-12 text-center"
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
          ...
          <motion.div whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(59, 130, 246, 0.4)" }} whileTap={{ scale: 0.95 }}>
            <Link
              href="/auth/register"
              className="inline-block px-8 py-4 bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold rounded-lg transition-all shadow-lg shadow-emerald-500/20"
            >
              Get Started Now
            </Link>
          </motion.div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-emerald-400/10 to-teal-400/10 border border-emerald-500/20 rounded-2xl p-8 text-center"
          >
            <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full flex items-center justify-center text-white font-bold text-3xl">
              TB
            </div>
            <h3 className="text-2xl font-bold text-white mb-2">Tripp Browning</h3>
            <div className="text-emerald-400 font-semibold mb-3">Lead Developer & CEO</div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-emerald-400/10 to-teal-500/10 border border-emerald-400/20 rounded-2xl p-8 text-center"
          >
            <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full flex items-center justify-center text-white font-bold text-3xl">
              CR
            </div>
            <h3 className="text-2xl font-bold text-white mb-2">Carson Rios</h3>
            <div className="text-emerald-400 font-semibold mb-3">Co-Founder & CEO</div>
            <p className="text-white/60 mb-4">
            ...
            <div className="flex h-[calc(100%-64px)]" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className={`w-full px-4 py-3 rounded-lg text-left transition-all ${
                      demoTab === 'leads'
                        ? 'bg-emerald-500/20 border border-emerald-500/30 text-white font-medium'
                        : 'text-white/60 hover:bg-white/5'
                    }`}
                  >
                    Leads (247)
                  ...
                  <button
                    ...
                    className={`w-full px-4 py-3 rounded-lg text-left font-medium transition-all ${
                      demoTab === 'plans'
                        ? 'bg-gradient-to-r from-emerald-400/30 to-amber-500/30 border border-emerald-400/50 text-emerald-200'
                        : 'bg-gradient-to-r from-emerald-400/20 to-teal-400/20 border border-emerald-400/40 text-emerald-300 hover:from-emerald-400/30 hover:to-amber-500/30'
                    }`}
                  >
                    Plans & Billing
                  </button>
              ...
              <div className="flex-1 p-6 overflow-y-auto pointer-events-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="p-4 bg-white/5 border border-white/10 rounded-xl hover:border-emerald-500/30 transition-colors">
                    <div className="text-white/60 text-sm mb-1">Total Leads</div>
                    <div className="text-2xl font-bold text-white">1,847</div>
                    <div className="text-emerald-400 text-sm mt-1">↑ 23% from last month</div>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/10 rounded-xl hover:border-emerald-500/30 transition-colors">
                    <div className="text-white/60 text-sm mb-1">Active Campaigns</div>
                    <div className="text-2xl font-bold text-white">12</div>
                    <div className="text-emerald-400 text-sm mt-1">5 scheduled, 7 running</div>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/10 rounded-xl hover:border-emerald-500/30 transition-colors">
                    <div className="text-white/60 text-sm mb-1">Response Rate</div>
                    <div className="text-2xl font-bold text-white">72.4%</div>
                    <div className="text-emerald-400 text-sm mt-1">↑ 8.3% from last week</div>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/10 rounded-xl hover:border-emerald-500/30 transition-colors">
                    <div className="text-white/60 text-sm mb-1">AI Conversations</div>
                    <div className="text-2xl font-bold text-white">1,203</div>
                    <div className="text-emerald-400 text-sm mt-1">94.7% automation</div>
                  </div>
                </div>

                {/* Quick Actions */}
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                  <button onClick={(e) => e.preventDefault()} className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-lg hover:bg-emerald-500/20 transition-all text-left cursor-pointer">
                    <div className="text-emerald-400 font-semibold">Send Campaign</div>
                    <div className="text-white/60 text-sm mt-1">Start new outreach</div>
                  </button>
                  <button onClick={(e) => e.preventDefault()} className="p-4 bg-emerald-400/10 border border-emerald-400/30 rounded-lg hover:bg-emerald-400/20 transition-all text-left cursor-pointer">
                    <div className="text-emerald-400 font-semibold">Add Lead</div>
                    <div className="text-white/60 text-sm mt-1">Import or create</div>
                  </button>
                  <button onClick={(e) => e.preventDefault()} className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-lg hover:bg-emerald-500/20 transition-all text-left cursor-pointer">
                    <div className="text-emerald-400 font-semibold">AI Workflow</div>
                    <div className="text-white/60 text-sm mt-1">Setup automation</div>
                  </button>
                  <button onClick={(e) => e.preventDefault()} className="p-4 bg-emerald-400/10 border border-emerald-400/30 rounded-lg hover:bg-emerald-400/20 transition-all text-left cursor-pointer">
                    <div className="text-emerald-400 font-semibold">View Analytics</div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="px-3 py-1 bg-emerald-500/20 text-emerald-400 text-sm rounded-full">Scheduled</span>
                        <button className="text-white/60 hover:text-white">
                          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                ...
                {/* CTA */}
                <div className="mt-6 p-6 bg-gradient-to-r from-emerald-400/20 to-teal-400/20 border border-emerald-500/30 rounded-xl text-center">
                  ...
                  <Link
                    href="/auth/register"
                    className="inline-block px-6 py-3 bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold rounded-lg transition-all"
                  >
                    Create Free Account
                  </Link>
                </div>
                            ...
                            {demoLeads.map((lead) => (
                              <tr
                                ...
                                className={`border-b border-white/5 hover:bg-white/5 transition-colors cursor-pointer ${
                                  selectedLead === lead.id ? 'bg-emerald-500/10' : ''
                                }`}
                              >
                                ...
                                <td className="px-4 py-3">
                                  <span className={`px-2 py-1 text-sm rounded-full ${
                                    ...
                                    lead.temp === 'Warm' ? 'bg-emerald-400/20 text-emerald-400' :
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-1">
                                      {lead.tags.map((tag, i) => (
                                        <span key={i} className="px-2 py-1 bg-emerald-500/20 text-emerald-400 text-sm rounded">
                                          {tag}
                                        </span>
                                      ))}
                                    </div>
                                  ...
                                  <button className="w-full mt-4 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors">
                                    Send Message
                                  </button>
                                </div>
                              );
                        ...
                        {demoConversations.map((conv) => (
                          <div
                            ...
                            className={`p-4 border-b border-white/5 hover:bg-white/5 cursor-pointer transition-colors ${
                              selectedConversation === conv.id ? 'bg-emerald-500/10 border-l-4 border-l-emerald-500' : ''
                            } ${conv.unread ? 'bg-emerald-500/5' : ''}`}
                          >
                          ...
                          {demoConversations[selectedConversation].messages.map((msg, i) => (
                            <div key={i} className={`flex ${msg.sender === 'agent' ? 'justify-end' : 'justify-start'}`}>
                              <div className={`rounded-lg px-4 py-2 max-w-[70%] ${
                                msg.sender === 'agent' ? 'bg-emerald-600' : 'bg-white/10'
                              }`}>
                ...
                {demoTab === 'campaigns' && (
                  <>
                    ...
                    <button className="mb-6 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-colors">
                      + Create New Campaign
                    </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        ...
                        <div key={i} className="p-6 bg-white/5 border border-white/10 rounded-xl hover:border-emerald-500/30 transition-colors">
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <span className={`px-3 py-1 text-sm rounded-full ${
                              ...
                              campaign.status === 'Scheduled' ? 'bg-emerald-500/20 text-emerald-400' :
                ...
                {demoTab === 'workflows' && (
                  <>
                    ...
                    <button className="mb-6 px-6 py-3 bg-emerald-400 hover:bg-emerald-500 text-white font-semibold rounded-lg transition-colors">
                      + Create AI Workflow
                    </button>
                          ...
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div className={`px-3 py-1 rounded-full text-sm ${
                                workflow.active ? 'bg-emerald-500/20 text-emerald-400' : 'bg-gray-500/20 text-gray-400'
                              }`}>
                      ...
                      <div className="h-64 flex items-end justify-between gap-2">
                        {[45, 62, 58, 73, 81, 95, 88].map((height, i) => (
                          <div key={i} className="flex-1 flex flex-col items-center">
                            <div className="w-full bg-gradient-to-t from-emerald-400 to-teal-400 rounded-t" style={{ height: `${height}%` }}></div>
                ...
                {(demoTab === 'templates' || demoTab === 'phone' || demoTab === 'plans') && (
                  <div className="text-center py-20">
                    ...
                    <Link
                      href="/auth/register"
                      className="inline-block mt-6 px-6 py-3 bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold rounded-lg transition-all"
                    >
                      Sign Up to Access
                    </Link>
                  </div>

  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-white/60">Ensuring regulatory compliance for SMS marketing</p>
      </div>
      ...
      <div className="card space-y-6">
        ...
        <section>
          ...
          <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4 space-y-2">
            ...
            <p className="text-white/80">✓ Ensuring message content complies with regulations</p>
            <p className="text-white/80">✓ Monitoring your campaigns for compliance issues</p>
            <p className="text-white/80">✓ Staying informed about regulation changes</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 space-y-2">
            <p className="text-white/80">✗ Illegal products or services</p>
            <p className="text-white/80">✗ Adult content or sexual services</p>
            <p className="text-white/80">✗ Gambling or online betting</p>
            <p className="text-white/80">✗ Cannabis or controlled substances</p>
            <p className="text-white/80">✗ Firearms or weapons</p>
            <p className="text-white/80">✗ Hate speech or harassment</p>
            <p className="text-white/80">✗ Phishing or fraudulent schemes</p>
            <p className="text-white/80">✗ Debt consolidation or payday loans</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 space-y-2">
            ...
            <p className="text-white/80">☑ Check that message timing complies with TCPA hours</p>
            <p className="text-white/80">☑ Review content for prohibited material</p>
            <p className="text-white/80">☑ Test messages for proper formatting and delivery</p>
            <p className="text-white/80">☑ Monitor responses and handle opt-outs promptly</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="mt-3 p-4 bg-white/5 rounded-lg">
            <p className="text-white/80">Email: compliance@hyvewyre.com</p>

          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                ...
                <div className="px-3 py-1 bg-amber-100 dark:bg-amber-900/30 border border-amber-300 dark:border-amber-600 text-amber-700 dark:text-amber-400 rounded-full text-sm font-medium">
                  CEO
                </div>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg transition-colors text-sm font-medium"
                >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Visit our site for more ways to reach the HyveWyre team
              </p>
            </div>
            <a
              href="/preview"
              className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg transition-colors text-sm font-medium whitespace-nowrap"
            >
              Back to HyveWyre
            </a>
          </div>

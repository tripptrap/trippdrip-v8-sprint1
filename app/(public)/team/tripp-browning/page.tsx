      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="card">
          <div className="flex items-start gap-6">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-sky-400 to-sky-600 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                <div className="px-3 py-1 bg-sky-100 dark:bg-sky-900/40 border border-sky-300 dark:border-sky-700 text-sky-700 dark:text-sky-400 rounded-full text-sm font-medium">
                  Developer
                </div>
                <div className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-700 text-blue-700 dark:text-sky-400 rounded-full text-sm font-medium">
                  Authorized Representative
                </div>
                <div className="px-3 py-1 bg-slate-100 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-sky-400 rounded-full text-sm font-medium">
                  Technical Lead
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg transition-colors text-sm font-medium w-full justify-center"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-slate-100 rounded-lg transition-colors text-sm font-medium w-full justify-center"
                  >
                    <Mail className="h-4 w-4" />
        ...
        {/* About + CTA */}
        <div className="card bg-sky-50 dark:bg-sky-900/20 border-sky-200 dark:border-sky-700/50">
          ...
          <div className="flex gap-3">
            ...
            <a
              href="mailto:support@hyvewyre.com"
              className="px-4 py-2 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-900 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-lg transition-colors text-sm font-medium"
            >
              Contact Us
            </a>
          </div>

...
export default function Dashboard(){
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <h1 className="text-xl md:text-2xl font-semibold pl-12 md:pl-0">Dashboard</h1>

      {/* Key Metrics */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        <div className="card bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/20 p-4">
        ...
        <div className="card bg-gradient-to-br from-green-500/10 to-green-600/10 border border-green-500/20 p-4">
        ...
        <div className="card bg-gradient-to-br from-purple-500/10 to-purple-600/10 border border-purple-500/20 p-4">
        ...
        <div className="card bg-gradient-to-br from-orange-500/10 to-orange-600/10 border border-orange-500/20 p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
        <div className="card p-4">
          <div className="flex items-center justify-between">
            ...
            <svg className="w-8 h-8 md:w-10 md:h-10 text-blue-400 flex-shrink-0 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between">
            ...
            <svg className="w-8 h-8 md:w-10 md:h-10 text-green-400 flex-shrink-0 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="card bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 p-4 md:p-6">
      ...
      {/* Points Cost Guide */}
      <div className="card bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-3">
          <div className="flex items-center justify-between p-2 md:p-3 bg-white/5 rounded-lg border border-white/10">
            ...
            <span className="text-xs md:text-sm font-bold text-blue-400 ml-2 flex-shrink-0">{POINT_COSTS.sms_sent} pt</span>
          </div>
          ...
          <div className="flex items-center justify-between p-2 md:p-3 bg-white/5 rounded-lg border border-white/10">
            ...
            <span className="text-xs md:text-sm font-bold text-purple-400 ml-2 flex-shrink-0">{POINT_COSTS.ai_response} pts</span>
          </div>
          ...
          <div className="flex items-center justify-between p-2 md:p-3 bg-white/5 rounded-lg border border-white/10">
            ...
            <span className="text-xs md:text-sm font-bold text-green-400 ml-2 flex-shrink-0">{POINT_COSTS.document_upload} pts</span>
          </div>
          ...
          <div className="flex items-center justify-between p-2 md:p-3 bg-white/5 rounded-lg border border-white/10">
            ...
            <span className="text-xs md:text-sm font-bold text-orange-400 ml-2 flex-shrink-0">{POINT_COSTS.bulk_message} pts</span>
          </div>
          ...
          <div className="flex items-center justify-between p-2 md:p-3 bg-white/5 rounded-lg border border-white/10">
            ...
            <span className="text-xs md:text-sm font-bold text-pink-400 ml-2 flex-shrink-0">{POINT_COSTS.flow_creation} pts</span>
          </div>
        </div>

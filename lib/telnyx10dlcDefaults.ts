...
export function generateCampaignDefaults(input: CampaignDefaultsInput): CampaignDefaults {
  ...
  return {
    ...
    messageFlow: `Consumers opt in through ${optInLocation}. The form includes a phone number field and a separate, unchecked SMS consent checkbox reading: "I agree to receive SMS text messages from ${business} at the phone number provided, including ${offer} follow-up and appointment reminders. Message and data rates may apply. Message frequency varies. Consent is not a condition of purchase. Reply STOP to opt out at any time, HELP for help." The checkbox links to ${business}'s Privacy Policy and Terms of Service, and is separate from any terms-of-service agreement. ${business} then uses HyveWyre to follow up by SMS only with consumers who checked that box.`,
